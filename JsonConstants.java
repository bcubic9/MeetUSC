public abstract class JsonConstants {
    ...
    public static final String     GROUP_SHORT_DESCRIPTION = "Baseball fans";
    ...
    public static final String[]   GROUP_CHAT_MESSAGES = {"Hello, everyone reading this. I hope you would like to come and help us help others"};
